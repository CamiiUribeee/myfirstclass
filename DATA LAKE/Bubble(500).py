...
def main():
    ...
    print(f"  • Comparaciones máximas: {500*499//2} vs {100*99//2} (n×(n-1)/2)")
    print(f"  • Factor de crecimiento: {(500**2)/(100**2)}x")
    print()
    print("COMPARACIÓN CON OTROS ALGORITMOS (n=500):")
    print(f"  • Bubble Sort:    ~62,500 comparaciones | ~50-100 ms")
    print(f"  • Insertion Sort: ~62,500 comparaciones | ~12-20 ms")
    print(f"  • Selection Sort: 124,750 comparaciones | ~12-25 ms")
    print(f"  • Merge Sort:      ~4,483 comparaciones | ~1-2 ms ⚡")
    print(f"  • Quick Sort:      ~6,200 comparaciones | ~0.5-1 ms ⚡⚡")
    print()
