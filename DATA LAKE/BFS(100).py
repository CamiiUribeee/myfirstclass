...
def bfs(grafo, inicio):
    ...
    comparaciones = 0  # veces que se verifica si un nodo fue visitado
    intercambios = 0   # veces que se agrega un nodo a la cola
...
def main():
    ...
    print("Recorrido completo:", "Sí" if visitados == n else "Parcial")
    print()
